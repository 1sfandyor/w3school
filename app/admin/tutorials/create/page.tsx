...
import { getCategories, getTags, createTutorial } from '@/lib/api';
...
export default function CreateTutorialPage() {
  ...
  // Kategoriya va teglarni yuklash
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        setError('Kategoriya va teglar ma\'lumotlarini yuklashda xatolik yuz berdi');
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleTitleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!slug || slug === '') {
      const newSlug = newTitle
        ...
        .replace(/--+/g, '-') // Qayta takrorlanuvchi chiziqchalarni bittalab qo'yish
        .trim();
    ...
    <DashboardLayout>
      <div className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold">Yangi darslik yaratish</h1>
        </div>
                ...
                <div className="md:col-span-2 space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      placeholder="darslik-slug"
                    />
                    <p className="mt-1 text-xs text-gray-500">
                      Darslik URL manzili: /tutorials/{slug || 'darslik-slug'}
                    </p>
                  </div>
